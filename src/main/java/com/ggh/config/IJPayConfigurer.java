...
import com.ggh.interceptor.AliPayInterceptor;
import com.ggh.interceptor.WxPayInterceptor;
...
public class IJPayConfigurer extends WebMvcConfigurationSupport {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        // 本地
        // registry.addResourceHandler("/**").addResourceLocations("file:D://web/");
        // 服务器
        registry.addResourceHandler("/**").addResourceLocations("file:/home/zwj/static/");
    }
